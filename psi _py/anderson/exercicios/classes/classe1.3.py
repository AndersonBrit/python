...
def main():
    ...
    caminho = r"C:\Users\dedeg\Desktop\PSI _PY\anderson\projetos\classes\classe1.3.txt"
    lista_pessoas = []
        ...
        if menu == 1:
            ...
            for _ in range(var_repeticao):
                ...
                with open(caminho, "a") as ficheiro:             
                    ...
                    ficheiro.write(f"Nome: {pessoa.nome}, Idade: {pessoa.idade}\n")  
